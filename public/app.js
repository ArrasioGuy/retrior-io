  ...
  const drawEntity = (
    ...
    if (
      ...
      yy =
        ...
        (drawSize * m.position.axis * m.position.middle.x * Math.sin(rot)) / 4;
    ...
    for (let i = 0; i < source.guns.length; i++) {
      ...
      if (!g.drawAbove) {
        ...
        drawTrapezoid(
          ...
          xx + drawSize * gx,
          yy + drawSize * gy,
          (drawSize * (g.length - positions[i])) / 2,
          (drawSize * g.width) / 2,
          g.aspect,
          g.angle + rot,
          borderless,
  ...
  function drawEntityIcon(
    ...
    ctx.fillStyle =
      picture.upgradeColor != null
        ...
        : gameDraw.getColor(colorIndex > 18 ? colorIndex - 19 : colorIndex);
    drawGuiRect(x, y, len, height);
    ctx.globalAlpha = 0.1;
    ctx.fillStyle =
      picture.upgradeColor != null
        ? gameDraw.getColor(picture.upgradeColor)
        : gameDraw.getColor(colorIndex - 9);
